...
def get_args():
    ...
    parser.add_argument('--val_freq', type = int, default=10, help = 'test freq')
    parser.add_argument('--keys', type=str, default=None, help = "memory bank keys' path")
    parser.add_argument('--values', type=str, default=None, help = "memory bank values' path")
    parser.add_argument(
        '--resume', 
        action='store_true', 
        default=False, 
